    ...
    <div class="row">
        ...
        <form method="post" action ="{{url('user')}}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="tel" class="form-control" value ="{{$user->tel}}" placeholder="ป้อนเบอร์โทร"/>
            </div>

            <div class="form-group">
                <label for="email">อีเมลล์</label>
                <input type="text" name="email" class="form-control" value ="{{$user->email}}" placeholder="ป้อนอีเมลล์"/>
            </div>

            <div class="form-group">
                <label for="address">ที่อยู่</label>
                <input type="text" name="address" class="form-control" value ="{{$user->address}}" placeholder="ป้อนที่อยู่"/>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="code" class="code form-control" value ="{{$user->code}}" placeholder="ใส่รหัสไปรษณีย์"/>
            </div>
           ...
           $.ajax({
               ...
               success:function(data){
                  ...
                  for(var i=0 ;i<data.length;i++){
                      op+='<option value ="'+data[i].districts_name+'">'+data[i].
